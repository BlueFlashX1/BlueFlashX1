...
| --------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| [**Healthcare Readmission Prediction**](https://github.com/BlueFlashX1/Data-Science-Portfolio/tree/master/projects/data-science/foundation-of-data-science) | Developed Random Forest classifier for 30-day readmission risk; placed 5th/40 in class competition (ROC AUC 0.90) from 125,958 EHR encounters       | Python, Scikit-learn |
